...
public class BeanFieldSecondaryIndex<EntityType extends EntityObject, AttributeType> extends SimpleMapSetSecondaryIndex<EntityType> {
  ...
  public BeanFieldSecondaryIndex(String name, PrimaryIndex<EntityType> primaryIndex, Class<AttributeType> fieldType, String fieldName) {
    super(name, primaryIndex);
    this.fieldType = fieldType;
    this.fieldName = fieldName;
  }

  public BeanFieldSecondaryIndex(String name, PrimaryIndex<EntityType> primaryIndex, Class<AttributeType> fieldType, String fieldName, MapSet<Object, EntityType> map) {
