...
public class TestEntityStore extends TestCase {
  ...
  public void test() {
    ...
    SecondaryIndex<LegalPerson, Long, LegalPerson> legalPersonsByName = new LegalPersonsByName("legalPersonsByName", store.getPrimaryIndex(Long.class, LegalPerson.class));
    assertTrue(store.registerSecondaryIndex(legalPersonsByName));

    // try to register it again
    SecondaryIndex<LegalPerson, Long, LegalPerson> legalPersonsByNameNotUsed = new LegalPersonsByName("legalPersonsByName", store.getPrimaryIndex(Long.class, LegalPerson.class));
...
//        System.out.println("deleted " + object.getName());
    ...
    SecondaryIndex<Human, Long, Human> humansByLastName = new HumansByLastName("humansByLastName", store.getPrimaryIndex(Long.class, Human.class));
